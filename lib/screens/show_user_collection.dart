...
class QuotesUserCollectionScreen extends StatefulWidget {
 ...
 var db;
  ...
  @override
  _QuotesUserCollectionScreenState createState() => _QuotesUserCollectionScreenState();
}

class _QuotesUserCollectionScreenState extends State<QuotesUserCollectionScreen> {
  @override
              ...
              return Dismissible(
                ...
                onDismissed: (dir){
                  widget.userDao.deleteQuote(quotesList[index]);
                    showSnackBar(context: context,value:'Quote is Deleted from Databse Successfully',icon:Icon(
                                              Icons.delete,
                                              color: Colors.red,
                                            ),
                                                );
                      ...
                      children: [
                        ListTile(
                          leading: ClipRRect(
                            ...
                            child: Image(
                              image: quotesList[index].quoteImageUrl != null
                                  ? NetworkImage(quotesList[index].quoteImageUrl )
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                                InkWell(
                                  onTap: () async {
                                   await  widget.userDao.deleteQuote(quotesList[index]);
                                   showSnackBar(context: context,value:'Quote is Deleted from Databse Successfully',icon:Icon(
                                              Icons.delete,
                                              color: Colors.red,
                                            ),
                              ...
                              InkWell(
                                onTap: () async {
                                  SocialShare.copyToClipboard(
                                   ...
                                   showSnackBar(context: context,value: 'Quote is copied in your clipboard',icon: Icon(
